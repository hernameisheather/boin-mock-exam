...
export default function HomePage() {
  ...
  if (stage === "result") return <ResultView result={result} />;
  return null;
}
  ...
  return (
    <div style={S.container}>
      ...
      <div style={{
        ...
        ✅ <b>제출이 완료되었습니다.</b><br/>
        위 성적표를 <b>스크린샷으로 저장</b>하여 보관하세요.<br/>
        나중에 점수를 다시 확인하려면 <a href="/lookup" style={{ color: "#0369a1", fontWeight: 700 }}>여기</a>를 클릭하세요.
      </div>
    </div>
  );
}
